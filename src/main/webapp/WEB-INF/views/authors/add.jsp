...
<div class="container">
    <div class="card">
        ...
        <form:form method="post" action="/authors/add" modelAttribute="author">
            ...
            <div class="form-group">
                ...
                <form:input path="email" id="email" type="text" placeholder="author@example.com"/>
            ...
            <div class="form-group">
                ...
                <form:input path="birthYear" id="birthYear" type="number" placeholder="e.g. 1980"/>

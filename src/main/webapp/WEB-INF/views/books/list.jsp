...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        nav a { color: #fff; text-decoration: none; margin-left: 20px; font-size: 0.95rem; padding: 6px 14px; border-radius: 20px; transition: background 0.2s; }
...
<div class="container">
    <div class="page-header">
        <h2>All Books (with Author Details)</h2>
                ...
                <tbody>
                    <c:forEach var="b" items="${bookDetails}" varStatus="s">
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="/books/edit/${b.bookId}" class="btn btn-warning">Edit</a>
                                    <a href="/books/delete/${b.bookId}"
